  ...
  return (
    <main className="flex-1 p-4 md:p-8 bg-background/90 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="border-2 border-dashed border-amber-500/30 rounded-xl min-h-[50vh] flex flex-col items-center justify-center text-center p-8 bg-amber-900/10">
            <div className="relative mb-4">
                 <div className="absolute inset-0 bg-amber-500/20 rounded-full animate-ping"/>
                <MailWarning className="relative z-10 size-20 text-amber-400" />
            </div>
            <h2 className="text-xl font-bold text-amber-300">La Bandeja de Spam está Limpia</h2>
            <p className="text-amber-200/70 mt-2 max-w-md">
              Nuestro sistema de IA no ha detectado correos sospechosos o no deseados. Cuando lo haga, aparecerán aquí para tu revisión.
            </p>
        </div>
      </div>
    </main>
